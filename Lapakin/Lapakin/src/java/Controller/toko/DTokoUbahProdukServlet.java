 ...
 * @author kiki
 */
@WebServlet(name = "DTokoUbahProdukServlet", urlPatterns = {"/DTokoUbahProdukServlet"})
public class DTokoUbahProdukServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id_produk = request.getParameter("id");
        ModelProduk mp = new ModelProduk();
        Produk p = mp.getDataProduk(id_produk);
        request.setAttribute("produk", p);
        RequestDispatcher control;
        control = getServletContext().getRequestDispatcher("/pemilik_toko/ubah_barang.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ModelProduk mp = new ModelProduk();
        newP.setId_produk(request.getParameter("id_produk"));
        ...
        RequestDispatcher control;
        if (mp.update(newP)) {
            request.setAttribute("status", "ubah berhasil");
        }else{
            request.setAttribute("status", "ubah gagal");
        }
        request.setAttribute("id_produk", request.getParameter("id_produk"));
